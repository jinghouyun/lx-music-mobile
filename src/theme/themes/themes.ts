...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(4, 112, 230)",
        "c-primary-dark-100": "rgb(4,101,207)",
        "c-primary-dark-100-alpha-100": "rgba(4, 101, 207, 0.90)",
        "c-primary-alpha-100": "rgba(4, 112, 230, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(4, 101, 207, 0.80)",
        "c-primary-alpha-200": "rgba(4, 112, 230, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(4, 101, 207, 0.70)",
        "c-primary-alpha-300": "rgba(4, 112, 230, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(4, 101, 207, 0.60)",
        "c-primary-alpha-400": "rgba(4, 112, 230, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(4, 101, 207, 0.50)",
        "c-primary-alpha-500": "rgba(4, 112, 230, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(4, 101, 207, 0.40)",
        "c-primary-alpha-600": "rgba(4, 112, 230, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(4, 101, 207, 0.30)",
        "c-primary-alpha-700": "rgba(4, 112, 230, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(4, 101, 207, 0.20)",
        "c-primary-alpha-800": "rgba(4, 112, 230, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(4, 101, 207, 0.10)",
        "c-primary-alpha-900": "rgba(4, 112, 230, 0.10)",
        "c-primary-dark-200": "rgb(4,91,186)",
        "c-primary-dark-200-alpha-100": "rgba(4, 91, 186, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(4, 91, 186, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(4, 91, 186, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(4, 91, 186, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(4, 91, 186, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(4, 91, 186, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(4, 91, 186, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(4, 91, 186, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(4, 91, 186, 0.10)",
        "c-primary-dark-300": "rgb(4,82,167)",
        "c-primary-dark-300-alpha-100": "rgba(4, 82, 167, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(4, 82, 167, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(4, 82, 167, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(4, 82, 167, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(4, 82, 167, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(4, 82, 167, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(4, 82, 167, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(4, 82, 167, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(4, 82, 167, 0.10)",
        "c-primary-dark-400": "rgb(4,74,150)",
        "c-primary-dark-400-alpha-100": "rgba(4, 74, 150, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(4, 74, 150, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(4, 74, 150, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(4, 74, 150, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(4, 74, 150, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(4, 74, 150, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(4, 74, 150, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(4, 74, 150, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(4, 74, 150, 0.10)",
        "c-primary-dark-500": "rgb(4,67,135)",
        "c-primary-dark-500-alpha-100": "rgba(4, 67, 135, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(4, 67, 135, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(4, 67, 135, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(4, 67, 135, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(4, 67, 135, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(4, 67, 135, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(4, 67, 135, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(4, 67, 135, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(4, 67, 135, 0.10)",
        "c-primary-dark-600": "rgb(4,60,122)",
        "c-primary-dark-600-alpha-100": "rgba(4, 60, 122, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(4, 60, 122, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(4, 60, 122, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(4, 60, 122, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(4, 60, 122, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(4, 60, 122, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(4, 60, 122, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(4, 60, 122, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(4, 60, 122, 0.10)",
        "c-primary-dark-700": "rgb(4,54,110)",
        "c-primary-dark-700-alpha-100": "rgba(4, 54, 110, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(4, 54, 110, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(4, 54, 110, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(4, 54, 110, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(4, 54, 110, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(4, 54, 110, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(4, 54, 110, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(4, 54, 110, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(4, 54, 110, 0.10)",
        "c-primary-dark-800": "rgb(4,49,99)",
        "c-primary-dark-800-alpha-100": "rgba(4, 49, 99, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(4, 49, 99, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(4, 49, 99, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(4, 49, 99, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(4, 49, 99, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(4, 49, 99, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(4, 49, 99, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(4, 49, 99, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(4, 49, 99, 0.10)",
        "c-primary-dark-900": "rgb(4,44,89)",
        "c-primary-dark-900-alpha-100": "rgba(4, 44, 89, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(4, 44, 89, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(4, 44, 89, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(4, 44, 89, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(4, 44, 89, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(4, 44, 89, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(4, 44, 89, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(4, 44, 89, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(4, 44, 89, 0.10)",
        "c-primary-dark-1000": "rgb(4,40,80)",
        "c-primary-dark-1000-alpha-100": "rgba(4, 40, 80, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(4, 40, 80, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(4, 40, 80, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(4, 40, 80, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(4, 40, 80, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(4, 40, 80, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(4, 40, 80, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(4, 40, 80, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(4, 40, 80, 0.10)",
        "c-primary-light-100": "rgb(54,141,235)",
        "c-primary-light-100-alpha-100": "rgba(54, 141, 235, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(54, 141, 235, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(54, 141, 235, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(54, 141, 235, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(54, 141, 235, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(54, 141, 235, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(54, 141, 235, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(54, 141, 235, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(54, 141, 235, 0.10)",
        "c-primary-light-200": "rgb(94,164,239)",
        "c-primary-light-200-alpha-100": "rgba(94, 164, 239, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(94, 164, 239, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(94, 164, 239, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(94, 164, 239, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(94, 164, 239, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(94, 164, 239, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(94, 164, 239, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(94, 164, 239, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(94, 164, 239, 0.10)",
        "c-primary-light-300": "rgb(126,182,242)",
        "c-primary-light-300-alpha-100": "rgba(126, 182, 242, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(126, 182, 242, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(126, 182, 242, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(126, 182, 242, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(126, 182, 242, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(126, 182, 242, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(126, 182, 242, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(126, 182, 242, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(126, 182, 242, 0.10)",
        "c-primary-light-400": "rgb(152,197,245)",
        "c-primary-light-400-alpha-100": "rgba(152, 197, 245, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(152, 197, 245, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(152, 197, 245, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(152, 197, 245, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(152, 197, 245, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(152, 197, 245, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(152, 197, 245, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(152, 197, 245, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(152, 197, 245, 0.10)",
        "c-primary-light-500": "rgb(173,209,247)",
        "c-primary-light-500-alpha-100": "rgba(173, 209, 247, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(173, 209, 247, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(173, 209, 247, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(173, 209, 247, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(173, 209, 247, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(173, 209, 247, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(173, 209, 247, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(173, 209, 247, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(173, 209, 247, 0.10)",
        "c-primary-light-600": "rgb(189,218,249)",
        "c-primary-light-600-alpha-100": "rgba(189, 218, 249, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(189, 218, 249, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(189, 218, 249, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(189, 218, 249, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(189, 218, 249, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(189, 218, 249, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(189, 218, 249, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(189, 218, 249, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(189, 218, 249, 0.10)",
        "c-primary-light-700": "rgb(202,225,250)",
        "c-primary-light-700-alpha-100": "rgba(202, 225, 250, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(202, 225, 250, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(202, 225, 250, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(202, 225, 250, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(202, 225, 250, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(202, 225, 250, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(202, 225, 250, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(202, 225, 250, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(202, 225, 250, 0.10)",
        "c-primary-light-800": "rgb(213,231,251)",
        "c-primary-light-800-alpha-100": "rgba(213, 231, 251, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(213, 231, 251, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(213, 231, 251, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(213, 231, 251, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(213, 231, 251, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(213, 231, 251, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(213, 231, 251, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(213, 231, 251, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(213, 231, 251, 0.10)",
        "c-primary-light-900": "rgb(221,236,252)",
        "c-primary-light-900-alpha-100": "rgba(221, 236, 252, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(221, 236, 252, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(221, 236, 252, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(221, 236, 252, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(221, 236, 252, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(221, 236, 252, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(221, 236, 252, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(221, 236, 252, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(221, 236, 252, 0.10)",
        ...
        "c-750": "rgb(86,81,80)",
        "c-700": "rgb(98,93,91)",
        "c-650": "rgb(109,104,103)",
        "c-600": "rgb(120,116,115)",
        "c-550": "rgb(131,127,126)",
        "c-500": "rgb(143,139,138)",
        "c-450": "rgb(154,151,150)",
        "c-400": "rgb(165,162,161)",
        "c-350": "rgb(176,174,173)",
        "c-300": "rgb(188,185,185)",
        "c-250": "rgb(199,197,197)",
        "c-200": "rgb(210,209,208)",
        "c-150": "rgb(221,220,220)",
        "c-100": "rgb(233,232,232)",
        "c-050": "rgb(244,243,243)",
