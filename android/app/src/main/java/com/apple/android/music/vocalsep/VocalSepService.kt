...
class VocalSepService : Service() {
  ...
  companion object {
    const val ACTION_START = "com.apple.android.music.vocalsep.START"
    const val ACTION_CANCEL = "com.apple.android.music.vocalsep.CANCEL"
    const val ACTION_WARMUP = "com.apple.android.music.vocalsep.WARMUP"
